...
SECRET_KEY = 'django-insecure-am+dg$z(betgt!&1c399*&ki$$yo#i(8q=vbe$gd*d1*n#nk=@'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework.authentication.TokenAuthentication',  # Default authentication method
    ],
    # Other DRF settings...
}
